...
class List
{
    ...
    struct Node : Link
    {
        ...
        Node(const T &data, Link *prev, Link *next)
            : Link(prev, next), mData(data)
        {
        }
    };
...
public:
    ...
    // exception safety    assignment operator
    ...
    List &operator=(List &&other) noexcept
    {
        ...
        cpy.swap(*this); // TODO: SWAP function!!!!!!!!!
        return *this;
    }
    ...
    void swap(List &other) noexcept
    {
        ...
        else if (other.empty())
        {
            ...
            other.mPrev = mAnchor.mNext = &mAnchor;
        }
        else
        {
    ...
    public:
        ...
        {
            CIter r(*this);
            mPointerToElem = mPointerToElem->mPev;
            return r;
        }
